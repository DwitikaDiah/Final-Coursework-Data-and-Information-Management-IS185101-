...
def PDRB02():
    ...
    PDRB.append('Transportasi dan Pergudangan')
    PDRB.append('Penyediaan Akomodasi dan Makan Minum')
    PDRB.append('Informasi dan Komunikasi')
    PDRB.append('Jasa Keuangan dan Asuransi')
    PDRB.append('Real Estate')
